...
# python src/scaled/tools/inference/inference.py --weight_path $EXP_DIR/ckpt/denoising_unet-400000.pth --config $EXP_DIR/config/exp.yaml --inference_type rollout
