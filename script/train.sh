...
#SBATCH --job-name=exp5_conv
#SBATCH --partition=dgxl_irp
#SBATCH --qos=dgxl_irp_low

#SBATCH -e exp/exp5_conv/logs/%j-exp5_conv.err              # File to redirect stderr
#SBATCH -o exp/exp5_conv/logs/%j-exp5_conv.out              # File to redirect stdout
