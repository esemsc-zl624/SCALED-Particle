...
#SBATCH -e exp/exp3_complex_model/logs/%j-exp3_complex_model.err              # File to redirect stderr
#SBATCH -o exp/exp3_complex_model/logs/%j-exp3_complex_model.out              # File to redirect stdout
